			...
			<section>
				<div class="container">
					<div class="col-md-8 col-sm-8">
						<form enctype="multipart/form-data" role="form" id="form" method="POST" action="{{ route('manage.article.update',$articles->id) }}" novalidate>
						{{ method_field('PUT') }}
						@csrf						
						<div class="row bottom-mrg extra-mrg">
							<form>
								<h2 class="detail-title">@lang('global.Edit Article')</h2> 
								...
								@endif							
								<div class="col-md-8 col-sm-8">
									<input type="text" class="form-control @error('title') is-invalid @enderror" placeholder="@lang('global.Subject')" name="title" value="{{old('title',$articles->title)}}" maxlength="50" required autofocus>
									@error('title')
							...
							<div class="form-row">
								<div class="form-group col-lg-2">							
									<div class="d-flex justify-content-center mb-4">
										<div class="profile-image-outer-containerCover">
											...
											@else
												<img src="{{asset('storage/uploads/article/'.$articles->cover)}}" class="imgCircleCover">										
											@endif									
								...
								<div class="col-md-12 col-sm-12">
									<input type="text" class="form-control @error('reference') is-invalid @enderror" placeholder="http://www/domain/article/01" value="{{old('reference',$articles->reference_link)}}" name="reference">
										@error('reference')
											<span class="invalid-feedback" role="alert">
												<strong>{{ $message }}</strong>
											</span>
						...
						<div class="row bottom-mrg extra-mrg">	
							...
							<div class="col-md-12 col-sm-12">
								<div class="input-group @error('active') is-invalid @enderror">
