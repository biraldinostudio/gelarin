					...
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
						...
						<div class="modal-body">
							<div class="apply-job-form">
								<form class="form-horizontal" action="{{route('article.comment.reply')}}" method="POST" role="form" novalidate>
								@csrf
									<div class="col-sm-12">
										<div class="form-group">
											<input type="text" class="form-control" name="idx" id="id_edit">
											<input type="text" class="form-control" name="article_id" id="article_id_edit">												
