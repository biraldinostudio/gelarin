...
<p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6em; font-weight: normal; margin: 0 0 10px; padding: 0;">{!! ($bodyMessage) !!}<br><br>@lang('mail.post_employer_contacted_content_1', [
        'name'      => $name,
        'email'     => $userCreatorEmail,
        'phone'     => $telp,
        'title'     => ucwords($subject),
        'postUrl'   => route('vacancies.detail',[$id,$slug]),
        'appUrl' 	=> url('/'),
